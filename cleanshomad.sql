...
--
-- Host: 127.0.0.1
-- Generation Time: May 20, 2020 at 05:53 AM
...
(1, 1, 'Renovasi Rumah', '<ol>\r\n	<li>Penggunaan jasa renovasi rumah profesional bisa menghemat waktu &amp; biaya.</li>\r\n	<li>Kesalahan dalam renovasi rumah berakibat buruk untuk keselamatan keluarga.</li>\r\n	<li>Mempelajari&nbsp;struktur&nbsp;bangunan lama cukup penting sebelum renovasi.</li>\r\n	<li>Pemilihan material berkualitas akan memperpanjang umur bangunan.</li>\r\n	<li>Biaya renovasi mungkin lebih mahal dibanding bangun baru.</li>\r\n</ol>\r\n', '<p style="text-align:justify">Setiap bangunan yang Anda bangun memiliki umur bangunan dimana Anda harus segera melakukan renovasinya apabila bangunan sudah cukup tua. Karena jika Anda membiarkannya begitu saja, akan cukup membahayakan bagi keselamatan keluarga Anda.</p>\r\n\r\n<p style="text-align:justify">Disisi lain, desain rumah sekarang terus berkembang. Berbagai macam desain yang menarik dan unik, selalu muncul dari ide-ide para arsitek terbaik Indonesia. Tentunya, Anda akan merasa sangat bosan jika masih menggunakan desain yang lama sedang desain baru terus bermunculan.</p>\r\n\r\n<p style="text-align:justify">Kami sangat merekomendasikan Anda untuk melakukan peremajaan bangunan 5 &ndash; 10 tahun sekali sebagai langkah antisipasi kerusakan yang berakibat fatal dan juga sebagai penggantian desain yang dapat meningkatkan mood Anda saat dirumah.</p>\r\n', 'fa fa-home'),
(2, 1, 'Renovasi Kantor', '<ol>\r\n	<li>Dengan menciptakan suasana kerja yang nyaman membuat pekerjaan lebih efektif.</li>\r\n	<li>Menata&nbsp;kantor&nbsp;dapat membuat karyawan merasa kerasan berlama-lama dikantor.</li>\r\n	<li>Penggunaan ruang yang baik membuat proses alur pekerjaan lebih efektif dan efisien.</li>\r\n	<li>Memilih material berkualitas dapat memperpanjang lama umur bangunan.</li>\r\n	<li>Biaya renovasi kantor mungkin akan lebih mahal dibandingkan bangun baru.</li>\r\n</ol>\r\n', '<p style="text-align:justify">Setiap bangunan Anda memiliki umur bangunan dimana Anda harus melakukan renovasi apabila bangunan tersebut sudah cukup tua, jika Anda membiarkannya akan cukup membahayakan bagi keselamatan karyawan-karyawan Anda.</p>\r\n\r\n<p style="text-align:justify">Lain halnya, desain kantor yang sekarang terus berkembang. Bermacam-macam desain yang unik dan menarik, muncul dari ide para arsitek terbaik di Indonesia. Tentunya, sangat membosankan jika masih menggunakan desain yang lama sedang desain baru terus bermunculan.</p>\r\n\r\n<p style="text-align:justify">Kami merekomendasikan untuk melakukan peremajaan bangunan 5 &ndash; 10 tahun sekali sehingga langkah antisipasi kerusakan yang dapat berakibat fatal dan juga sebagai penggantian desain yang dapat meningkatkan mood karyawan Anda saat berada dikantor.</p>\r\n', 'fa fa-home'),
(4, 2, 'Kontraktor Rumah', '<ol>\r\n	<li>Menggunakan jasa bangun&nbsp;rumah&nbsp;profesional hemat waktu dan biaya</li>\r\n	<li>Kesalahan dalam bangun rumah mengakibatkan keselamatan keluarga terancam</li>\r\n	<li>Rumah impian dapat mengurangi stress akibat lelah bekerja</li>\r\n	<li>Desain rumah dapat mempengaruhi kebahagiaan penghuninya</li>\r\n	<li>Rumah yang indah dapat meningkatkan status sosial Anda</li>\r\n	<li>Penggunaan bahan material yang bagus dapat memperpanjang usia bangunan</li>\r\n</ol>\r\n', '<p style="text-align:justify">Kami sadar betul bahwa rumah yang indah, nyaman, dan tenang dapat membahagiakan para penghuninya. Oleh karena itu, kami ingin sekali menjadi bagian terpenting dalam kebahagiaan Anda dengan menghadirkan rumah yang nyaman, aman, tenang, dan tentu disentuh dengan desain yang sesuai keinginan Anda.</p>\r\n\r\n<p style="text-align:justify">Faktor terpenting selain keindahan rumah yang harus dijaga adalah keamanan bangunan. Kami memberikan perhatian khusus terhadap material-material yang kami gunakan serta metode kerja dalam pembangunan rumah sehingga dapat memenuhi standar operasional yang ada guna menjaga kualitas pekerjaan.</p>\r\n\r\n<p style="text-align:justify">Metode kerja yang memiliki standarisasi, dipadukan dengan bahan material berkualitas, dikerjakan oleh para tukang yang ahli dibidangnya masing-masing, serta dikelola menggunakan sistem teknologi terkini dapat membuahkan sebuah karya apik yang berkualitas dan nyaman untuk digunakan. Dan tentunya, menambah kebahagiaan Anda dan keluarga tercinta. ????</p>\r\n', 'fa fa-home'),
(5, 3, 'Instalasi Kaca Alumunium', '<ol>\r\n	<li>Kaca menjadi favorit dewasa ini</li>\r\n	<li>Pemilihan material yang tepat dapat menghemat pembangunan</li>\r\n	<li>Bintoro Steel kini jual kaca menarik berkualitas dan menyediakan jasa pasang kaca sesuai dengan impian Anda</li>\r\n</ol>\r\n', '<p style="text-align:justify">Kemewahan kaca alumunium tidak hanya hasil dari arsitek, melainkan juga hasil kerja dari kontraktor yang membuat kaca alumunium tersebut. Agar kaca Anda benar-benar bagus, gunakan jasa instalasi kaca alumunium dari BintoroBuild agar tim kami bisa saling terintegrasi menjadi satu kesatuan untuk membuat kaca alumunium impian Anda.</p>\r\n\r\n<p style="text-align:justify">BintoroBuild, memberikan kemewahan dalam desain, kenyamanan, dan rasa.</p>\r\n', 'fa fa-trello'),
...
(1, 'Jasa Renovasi', 'Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.', '<p><em>Lorem ipsum</em><strong>&nbsp;is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.</strong></p>\r\n', '', 'fa fa-road'),
(2, 'Kontraktor Bangunan', 'Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.', '<p><em>Lorem ipsum</em><strong>&nbsp;is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.</strong></p>\r\n', '', 'fa fa-home'),
(3, 'Instalasi', 'Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.', '<p><em>Lorem ipsum</em><strong>&nbsp;is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.</strong></p>\r\n', '', 'fa fa-wrench'),
(4, 'Jasa Lainnya', 'Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.', '<p><em>Lorem ipsum</em><strong>&nbsp;is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.</strong></p>\r\n', '', 'fa fa-pencil-square-o');
