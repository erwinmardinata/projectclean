	  ...
	  <div class="box box-primary">
        ...
        <div class="row">
            ...
            <div class="form-group">
              <label for="name">Layanan/Jasa</label>
              <input type="hidden" name="id" value="<?php echo $data->id; ?>" class="form-control" required="">
              <input type="hidden" name="id_program_detail" value="<?php echo $id; ?>" class="form-control">
              <input type="text" name="nama" value="<?php echo $data->nama; ?>" class="form-control" required="">
            </div>
            <div class="form-group">
              <label for="name">Tahukah Anda?</label>
              <textarea name="tahukah_anda" id="content" class="form-control" rows="5" required><?php echo $data->tahukah_anda; ?></textarea>
            </div>
            <div class="form-group">
              <label for="name">Deskripsi</label>
              <textarea name="deskripsi" id="content2" class="form-control" rows="5" required><?php echo $data->deskripsi; ?></textarea>
            </div>
            <div class="form-group">
      				<div>
        ...
        <div class="card-footer">
            <a href="<?php echo site_url($url.'/index/'.$id); ?>" class="btn btn-sm btn-warning">
