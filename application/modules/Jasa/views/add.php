...
<section class="content-header">
  <h1>
    <?php echo $judul; ?>
	<small>Tambah <?php echo $opd->judul; ?></small>
  </h1>
  <ol class="breadcrumb">
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <div class="form-group">
              ...
              <textarea name="tahukah_anda" id="content" class="form-control" rows="5" required></textarea>
            </div>
            <div class="form-group">
              <label for="name">Deskripsi</label>
              <textarea name="deskripsi" id="content2" class="form-control" rows="5" required></textarea>
            </div>
            <div class="form-group">
      				<div>
