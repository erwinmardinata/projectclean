<section class="content-header">
  ...
  <ol class="breadcrumb">
	...
	<li><a href="<?php echo site_url('Bookings'); ?>">Appointment</a></li>
	<li class="active">Lihat Appointment</li>
  </ol>
</section>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body no-padding">
        <div class="mailbox-read-info">
          <h3><?php
                $cek = $this->db->where('id', $data->id_jasa)->get('jasa')->row();
                echo $cek->nama;
              ?></h3>
          <h5>From: <?php echo $data->email; ?>
          <h5>Telepon: <?php echo $data->telp; ?>
        ...
        <?php
          // $cek = $this->db->where('id_Booking', $data->id)->get('balas_Booking')->result()
        ?>
<!--         <div style="padding: 15px 12px;">
              ...
              <span style="float: right"><small><?php echo $row->waktu; ?></small></span>
                <div class="media">
                  ...
                  <div class="media-body" style="font-size: 14px">
                    ...
                    <a href="<?php echo site_url('Bookings/hapus_basalan/'.$row->id.'/'.$data->id); ?>" onclick="return confirm('Anda Yakin')" class="btn btn-xs btn-danger" style="margin-top: -14px;float: right;">hapus</a>
                  </div>
                </div>
            <?php endforeach; } ?>
            </li>
 ...
 -->
      ...
      <!-- /.box-body -->
<!--       <form method="post" action="<?php echo site_url('Bookings/inserts'); ?>">
...
<!--       <div class="box-footer">
        ...
        <a href="<?php echo site_url('Bookings/hapus/'.$data->id); ?>" onclick="return confirm('Anda Yakin')" class="btn btn-danger"><i class="fa fa-trash-o"></i> Hapus</a>
        <a href="<?php echo site_url('Bookings'); ?>" class="btn btn btn-warning">
