...
<form method="POST" action="<?php echo site_url('Program_detail/insert'); ?>">
  <div class="row">
	<!-- left column -->
	<div class="col-md-8">
		...
		<!-- form start -->
		  ...
		  <div class="box-body">
			<div class="form-group">
			  ...
			  <input type="text" name="judul" value="<?php echo $this->session->flashdata('judul'); ?>" class="form-control" placeholder="Judul">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
			  ...
			  <textarea name="isi" id="content" class="form-control" placeholder="Isi" required><?php echo $this->session->flashdata('deskripsi'); ?></textarea>
			</div>
		  </div>
		  <!-- /.box-body -->
