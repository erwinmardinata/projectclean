...
<form method="POST" action="<?php echo site_url('Program_detail/update'); ?>">
  <div class="row">
	<!-- left column -->
	<div class="col-md-8">
		  ...
		  <div class="box-body">
			<div class="form-group">
			  <label for="exampleInputEmail1">Judul</label>
				<input type="hidden" name="id" value="<?php echo $data->id; ?>" class="form-control" placeholder="Program" required>
			  <input type="text" name="judul" value="<?php echo $data->judul; ?>" class="form-control" placeholder="Judul">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
			  ...
			  <textarea name="isi" id="content" class="form-control" placeholder="Deskripsi" required><?php echo $data->isi; ?></textarea>
			</div>
			</div>
			...
			<!-- form start -->
	          ...
	          ?>
				...
				<div class="box-footer">
					<a href="<?php echo site_url('Program_detail'); ?>" class="btn btn btn-danger">
