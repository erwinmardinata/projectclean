...
<section class="content-header">
  ...
  <ol class="breadcrumb">
	...
	<li><a href="<?php echo site_url('Misi'); ?>">Misi</a></li>
...
<form method="POST" action="<?php echo site_url('Misi/update'); ?>">
  <div class="row">
	<!-- left column -->
	<div class="col-md-9">
		  ...
		  <div class="box-body">
			<div class="form-group">
			  <label for="exampleInputEmail1">Judul</label>
				<input type="hidden" name="id" value="<?php echo $data->id; ?>" class="form-control" placeholder="Misi" required>
			...
			<div class="box-footer">
				<a href="<?php echo site_url('Misi'); ?>" class="btn btn btn-danger">
