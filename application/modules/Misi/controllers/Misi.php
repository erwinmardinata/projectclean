...
class Misi extends Back_controller {

	function __construct() {

		parent::__construct();
		$this->load->model('Mmisi', 'mdl');
	...
	function get_data() {
		...
		foreach($fetch_data as $row)
		{
				 ...
				 $sub_array[] = '<a href="'.site_url('Misi/edit/'.$row->id).'" class="btn btn-info btn-xs update">Edit</a>
				 <a href="'.site_url('Misi/delete/'.$row->id).'" onclick="return confirm(\'Apakah anda yakin?\')" class="btn btn-danger btn-xs delete">Delete</a>';
				 $data[] = $sub_array;
		}
		$output = array(
