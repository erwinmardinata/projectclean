...
class Blog extends Front_controller {
	...
	function index($num = null) {
		...
		$image = "";
		$subtitle = "blog";
		$content = $this->load->view('user/blog.php', $data_array, true);
	...
	function id($id) {
		...
		$data_array['berita2'] = $this->mdl->cek_data3($id);
		...
		$subtitle = "blog";
		$content = $this->load->view('user/blog_detail.php', $data_array, true);
